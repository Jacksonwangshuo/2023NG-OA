...
if __name__ == "__main__":
    ...
    parser.add_argument("--datapath", type=str, default="C:/Users/wangs/OneDrive/桌面/seq2seq-polynomial-master/seq2seq-polynomial-master/data/train.txt")
    parser.add_argument("--trainpath", type=str, default="C:/Users/wangs/OneDrive/桌面/seq2seq-polynomial-master/seq2seq-polynomial-master/data/train_set.txt")
    parser.add_argument("--testpath", type=str, default="C:/Users/wangs/OneDrive/桌面/seq2seq-polynomial-master/seq2seq-polynomial-master/data/test_set.txt")
